...
class IngestionRecordTest {
    ...
    private static DataSourceSpecification<TestBean> sourceSpecification;
    ...
    static void init() {
        ...
        sourceSpecification = (DataSourceSpecification<TestBean>) mock(DataSourceSpecification.class);
        doReturn(EXPECTED_DATASOURCE_ID).when(sourceSpecification).getId();
        doReturn(EXPECTED_DATA_CLASS).when(sourceSpecification).getDataClass();
        doReturn(EXPECTED_DATASOURCE_TYPE).when(sourceSpecification).getType();
    }
